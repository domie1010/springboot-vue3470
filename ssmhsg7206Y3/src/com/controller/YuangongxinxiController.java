...
//	分页查询
	...
	public String yuangongxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Yuangongxinxi yuangongxinxi, String zhanghao, String mima, String yuangongxingming, String xingbie, String nianling, String dianhua, String dizhi){
	...
	public void quchongYuangongxinxi(Yuangongxinxi yuangongxinxi,HttpServletResponse response){
		   ...
		   map.put("zhanghao", yuangongxinxi.getZhanghao());
		   System.out.println("zhanghao==="+yuangongxinxi.getZhanghao());
		   System.out.println("zhanghao222==="+yuangongxinxiService.quchongYuangongxinxi(map));
