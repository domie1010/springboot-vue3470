...
-->
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">消费列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xiaofeiList.do" name="myform" method="post">
    ...
    <td>${u.beizhu}</td>
                              ...
                              <td align="center"><a href="doUpdateXiaofei.do?id=${u.id }">编辑</a>  <a href="deleteXiaofei.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="xiaofeiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="xiaofeiList.do?page=1" >首页</a>
             <a href="xiaofeiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xiaofeiList.do?page=${page.page+1 }">下一页</a>
			<a href="xiaofeiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
