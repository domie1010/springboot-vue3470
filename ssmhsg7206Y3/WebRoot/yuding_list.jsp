...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="yudingList.do" name="myform" method="post">
    ...
    <td>${u.shifouruzhu}</td>
                              ...
                              <td align="center"><a href="ruzhu_add.jsp?id=${u.id }">入住</a> <a href="doUpdateYuding.do?id=${u.id }">编辑</a>  <a href="deleteYuding.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="yudingDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
