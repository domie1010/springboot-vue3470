...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateLvkexinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改客户信息<input type="hidden" name="id" value="${lvkexinxi.id}" /></td>
						</tr>
		...
		<tr ><td width="200">地址：</td><td><input name='dizhi' type='text' id='dizhi' value='' onblur='' size='50' style='border:solid 1px #000000; color:#666666' /></td></tr>
						...
						<script language="javascript">document.form1.lvkebianhao.value='${lvkexinxi.lvkebianhao}';</script>
	<script language="javascript">document.form1.lvkexingming.value='${lvkexinxi.lvkexingming}';</script>
	<script language="javascript">document.form1.xingbie.value='${lvkexinxi.xingbie}';</script>
	<script language="javascript">document.form1.dianhua.value='${lvkexinxi.dianhua}';</script>
	<script language="javascript">document.form1.dizhi.value='${lvkexinxi.dizhi}';</script>
